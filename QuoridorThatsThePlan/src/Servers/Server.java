...
public class Server {
			...
			while ((client = server.accept()) != null) {
				...
				while (cin.hasNextLine()) {
					...
					if (clientMessage.contains(MSG_QUORIDOR)) {
						...
						//System.out.println("MOVE " + playerNumber + " " + move);
						//cout.format("%s\n", MSG_MOVE + " " + SIMPLETOCOMPLEX.get(move));
						//updateBoard(playerNumber, SIMPLETOCOMPLEX.get(move), board);
						
						cout.format("%s\n", MSG_MOVE + " " + move);
						System.out.println(COMPLEXTOSIMPLE.get(move) + " look at this");
						updateBoard(playerNumber, move, board);
						...
						updateBoard(Integer.parseInt(movePieces[1]), movePieces[2], board);
	...
	public static void updateBoard(int player, String move, Board board) {
